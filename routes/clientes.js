...
router.post('/', async (req, res) => {
    try {
        ...
        const [result] = await db.query(
            ...
            [cedula || null, nombre, direccion || null, telefono || null]
        );
...
router.put('/:id', async (req, res) => {
    try {
        ...
        const [result] = await db.query(
            'UPDATE clientes SET cedula = ?, nombre = ?, direccion = ?, telefono = ? WHERE id = ?',
            [cedula || null, nombre, direccion || null, telefono || null, req.params.id]
        );
